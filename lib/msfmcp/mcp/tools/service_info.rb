  ...
  module MCPTools
    ...
    class ServiceInfo < ::MCP::Tool
      ...
      class << self
        ...
        #
        def call(workspace: 'default', names: nil, ports: nil, host: nil, protocol: nil, only_up: false, limit: MsfMcp::Security::InputValidator::LIMIT_DEFAULT, offset: 0, server_context:)
          start_time = Time.now
          ...
          MsfMcp::Security::InputValidator.validate_only_up!(only_up)
          MsfMcp::Security::InputValidator.validate_protocol!(protocol) if protocol
          MsfMcp::Security::InputValidator.validate_ip_address!(host) if host
          MsfMcp::Security::InputValidator.validate_port_range!(ports) if ports
