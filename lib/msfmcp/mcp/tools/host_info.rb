  ...
  module MCPTools
    ...
    class HostInfo < ::MCP::Tool
      ...
      class << self
        ...
        #
        def call(workspace: 'default', addresses: nil, only_up: false, limit: MsfMcp::Security::InputValidator::LIMIT_DEFAULT, offset: 0, server_context:)
          start_time = Time.now
          ...
          MsfMcp::Security::InputValidator.validate_ip_address!(addresses) if addresses
