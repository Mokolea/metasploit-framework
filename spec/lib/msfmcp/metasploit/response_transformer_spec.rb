...
RSpec.describe MsfMcp::Metasploit::ResponseTransformer do
  ...
  describe '.transform_notes' do
    ...
    it 'handles created_at as fallback for time' do
      response = { 'notes' => [{ 'host' => '192.168.1.1', 'created_at' => 1609459200 }] }
      result = described_class.transform_notes(response)
